...
if __name__ == '__main__':
    ...
    X = pd.DataFrame(X)
    X = X.iloc[176:276, [libscol.scol2int(GLUCOSE_10_COLUMN)] + list(range(libscol.scol2int(NANOTEMPER_START_COLUMN), libscol.scol2int(NANOTEMPER_END_COLUMN) + 1)))]
