...
console.log('💡 Use reportError(type, message, source) to report custom errors');
console.log('💡 Use window.errorReporter.getErrorSummary() for AI analysis');
console.log('💡 Use testError() to test the error panel'); 